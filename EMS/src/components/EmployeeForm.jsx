        ...
        <div className='card p-5 sm:p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                ...
                <div>
                    ...
                    <input type='number' name='basicSalary' required min='0' steps='0.01' defaultValue={initialData?.basicSalary || 0} />
                </div>
                <div>
                    <label className='block mb-2'>Allowances</label>
                    <input type='number' name='allowances' required
                    min='0' steps='0.01' defaultValue={initialData?.allowances} />
                </div>
                <div>
                    <label className='block mb-2'>Deductions</label>
                    <input type='number' name='deductions' required
                    min='0' steps='0.01' defaultValue={initialData?.deductions} />
                </div>
