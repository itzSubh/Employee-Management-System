    ...
    <div className='max-w-2xl mx-auto p-8 bg-white animate-fade-in'>
      ...
      <div className='grid grid-cols-2 gap-6 mb-8'>
        <div>
          ...
          <p className='font-semibold text-slate-900'>{payslip.employee?.firstName} {payslip.employee?.firstName}</p>
        </div>
        <div>
